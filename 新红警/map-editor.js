...
const UNIT_TYPES = ['infantry','tank','harvester','mcv','exo','magnet','abrams','t90','destroyer','transport'];
const UNIT_LABEL = { infantry:'步兵', tank:'坦克', harvester:'矿车', mcv:'基地车', exo:'外骨骼', magnet:'磁暴', abrams:'艾布拉姆', t90:'T90', destroyer:'驱逐舰', transport:'运输艇' };
